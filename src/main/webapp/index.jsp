...
<body>
  <div class="jumbotron" style="background-color:white">
     <h1 class="text-center">Welcome to</h1>
      ...
      <h1 class="text-center">My job is done with jenkins using POLL SCM Changing in between build</h1>
      <h2 class="text-center">Welcome to all leaders Ram, Test, Surendra, Pavan, Farooq, Abhilash on behalf of Infinito Solutions</h2>
